...
__END__
diff --git i/lib/modulator_bc_impl.cc w/lib/modulator_bc_impl.cc
index 8620bbe..f304ca5 100644
--- i/lib/modulator_bc_impl.cc
+++ w/lib/modulator_bc_impl.cc
@@ -49,32 +49,32 @@ namespace gr {
...
+                        m_16apsk[i].real(m_16apsk[i].real() / 1.2088);
+                        m_16apsk[i].imag(m_16apsk[i].imag() / 1.2088);
                     }
                 }
...
+                        m_16apsk[i].real(m_16apsk[i].real() / 1.2007);
+                        m_16apsk[i].imag(m_16apsk[i].imag() / 1.2007);
                     }
                 }
                 else
@@ -324,38 +324,38 @@ namespace gr {
                             r1 = 0;
                             break;
                     }
...
+                m_64apsk[63].imag(r2 * sin(5 * M_PI / 4.0));
             ...
             case gr::dvbs2::MOD_128APSK:
                 r6 = m;
@@ -1105,1302 +1105,1302 @@ namespace gr {
                         r5 = 0;
                         break;
                 }
...
+                        m_256apsk[i].real(m_256apsk[i].real() / 1.6747);
+                        m_256apsk[i].imag(m_256apsk[i].imag() / 1.6747);
                     }
                 }
...
+                        m_256apsk[i].real(m_256apsk[i].real() / 1.6329);
+                        m_256apsk[i].imag(m_256apsk[i].imag() / 1.6329);
                     }
                 }
                 else
@@ -2446,529 +2446,529 @@ namespace gr {
                             r7 = 0;
                             break;
                     }
...
diff --git i/lib/physical_cc_impl.cc w/lib/physical_cc_impl.cc
index e2c0882..f2a7099 100644
--- i/lib/physical_cc_impl.cc
+++ w/lib/physical_cc_impl.cc
@@ -69,25 +69,25 @@ namespace gr {
         }
         gold_code = goldcode;
...
@@ -692,20 +692,20 @@ void physical_cc_impl::build_symbol_scrambler_table(void)
                     switch (m_cscram[n++])
                     {
                         case 0:
...
@@ -723,20 +723,20 @@ void physical_cc_impl::build_symbol_scrambler_table(void)
                             switch (m_cscram[n++])
                             {
                                 case 0:
-                                    tempout.real() =  tempin.real();
